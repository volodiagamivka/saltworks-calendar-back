...
router.get('/calendar', function (req, res) {
    // Retrieve timing information with total people and individual tour status
    db.query(`
    ...
    `)
        .then(data => res.json(data))  // Send response data in JSON format
        .catch(err => res.status(500).send(err));  // Handle errors if any occur
});
